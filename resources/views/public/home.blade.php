...
@section('title', config('page_titles.public.home'))
...
@section('content')
            ...
            <div class="flex flex-col items-center gap-8 lg:flex-row lg:items-start lg:justify-between lg:gap-12">
                <div class="max-w-2xl">
                    ...
                    <p class="mt-10 text-body text-martinique-900 text-justify">
                        ...
                        Sanguine) des HUG. À travers ces collectes, les salarié.es et employeur.ses se rassemblent autour d'un même geste : sauver des vies.<br><br>
    ...
    <section class="px-6 py-8 lg:px-12 lg:py-16">
        <div class="mx-auto max-w-6xl lg:grid lg:grid-cols-2 lg:gap-x-8 lg:gap-y-8">
            ...
            {{-- Cartes : scroll horizontal sur mobile (avec chevrons) --}}
            <div class="relative -mx-6 mt-8 lg:m-0 lg:contents">
                ...
                <div id="prize-cards-scroll" class="flex snap-x snap-mandatory gap-4 overflow-x-auto px-6 pb-4 lg:contents">

                    {{-- Carte : Meilleur ambassadeur --}}
                    <article class="flex w-72 shrink-0 snap-center flex-col gap-3 rounded-2xl bg-white p-4 lg:col-start-2 lg:row-start-1 lg:w-auto lg:shrink lg:snap-align-none lg:grid lg:grid-cols-[1fr_auto] lg:grid-rows-[auto_1fr] lg:gap-x-4 lg:gap-y-3">
                        ...
                        <div class="relative shrink-0 lg:col-start-2 lg:row-span-2 lg:self-center">
                            ...
                            >
                                <img
                                    ...
                                    class="h-48 w-full object-cover lg:h-28 lg:w-auto"
                                    loading="eager"
                                />
                            </button>
                    ...
                    {{-- Carte : Coup de cœur du jury  --}}
                    <article class="flex w-72 shrink-0 snap-center flex-col gap-3 rounded-2xl bg-white p-4 lg:col-start-1 lg:row-start-2 lg:w-auto lg:shrink lg:snap-align-none lg:grid lg:grid-cols-[1fr_auto] lg:grid-rows-[auto_1fr] lg:gap-x-4 lg:gap-y-3">
                        <div class="w-fit rounded-full bg-razzmatazz-900 px-4 py-1 text-body font-medium text-white lg:col-start-1 lg:row-start-1">
                    ...
                    {{-- Carte : Meilleur donneur --}}
                    <article class="flex w-72 shrink-0 snap-center flex-col gap-3 rounded-2xl bg-white p-4 lg:col-start-2 lg:row-start-2 lg:w-auto lg:shrink lg:snap-align-none lg:grid lg:grid-cols-[1fr_auto] lg:grid-rows-[auto_1fr] lg:gap-x-4 lg:gap-y-3">
                        <div class="w-fit rounded-full bg-razzmatazz-900 px-4 py-1 text-body font-medium text-white lg:col-start-1 lg:row-start-1">
                            Meilleur donneur
                        </div>
                        <div class="relative shrink-0 lg:col-start-2 lg:row-span-2 lg:self-center">
                        ...
                        <p class="text-body text-martinique-950 lg:col-start-1 lg:row-start-2">
                            Récompense l'entreprise dont les collaborateur.rices ont effectué le plus de dons au
