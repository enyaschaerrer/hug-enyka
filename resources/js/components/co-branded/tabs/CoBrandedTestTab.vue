    ...
    <section class="mx-auto max-w-3xl px-6 pt-6 pb-32 sm:pt-10">
        ...
        <div class="rounded-2xl bg-razzmatazz-200 px-6 pt-10 pb-0 text-center lg:mt-10 lg:px-12">
            ...
            <div class="mt-2 flex translate-y-1/2 justify-center gap-4 lg:gap-6">
                <a
                    href="/"
                    class="w-32 rounded-2xl bg-razzmatazz-800 py-3 text-center text-heading-t3 font-semibold text-white transition hover:bg-razzmatazz-400 sm:w-44 sm:py-4"
                >
                    Pas encore
                </a>
                <button
                    type="button"
                    class="w-32 rounded-2xl bg-razzmatazz-800 py-3 text-center text-heading-t3 font-semibold text-white transition hover:bg-razzmatazz-900 sm:w-44 sm:py-4"
